...
;;; Code:
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'dark-flux
        ...
        `(font-lock-comment-face ((,class (:foreground ,comment :weight light))))
	...
	;; popup
	`(popup-face ((,class (:foreground ,green1 :background ,green2 ))))
	`(popup-isearch-match ((,class (:foreground ,purple2 :background ,green3 ))))
	`(popup-scroll-bar-background-face ((,class (:background ,gray1 ))))
	`(popup-scroll-bar-foreground-face ((,class (:background ,purple3 ))))
	`(popup-summary-face ((,class (:foreground ,green1))))
	`(popup-tip-face ((,class (:foreground ,purple2 :background ,green4 ))))
	`(popup-menu-mouse-face ((,class (:foreground ,purple2 :background ,green5 ))))
	`(popup-menu-selection-face ((,class (:foreground ,purple2 :background ,green6 ))))
